...
Termin oddwania projektu - siłą rzeczy - ostatnie laboratorium każdej grupy. Część tych zajęć poświecimy na pytania,
odpowiedzi i ewentualne poprawki. Jakby okazało się, że projekt jest jeszcze niewystaraczjąco gotowy, będzie można go
dosłać mailowo do 3.02, niemniej oczekuję, że na zajęciach każdy zaprezentuje mi przynajmnej częściowo działające
...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        CatsAndMiceGame catsAndMiceGame = new CatsAndMiceGame();
        catsAndMiceGame.start();
    }
}
